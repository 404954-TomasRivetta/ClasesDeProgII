...
namespace CarpinteriaApi.Controllers
{
    ...
    public class PresupuestoController : ControllerBase
    {
        ...
        //END POINT : GET , POUT, POST DELETE
        ...
        public IActionResult PostPresupuesto(Presupuesto oPresupuesto)
        {
            try
            {
                ...
                {
                    return BadRequest("Presupuesto Invalido,FALTAN CAMPOS...😯"); //ERROR DE PARTE DEL CLIENTE
                }
                if (app.SavePresupuesto(oPresupuesto))
                {
                    return Ok(oPresupuesto); //ME MUESTRA EL PRESUPUESTO QUE SE GRABO
                }
                else
                {
